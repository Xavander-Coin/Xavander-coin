Contributing to Xavander Core
============================

The Xavander Core project operates an open contributor model where anyone is
...
Examples:
    ...
    Consensus: Add new opcode for BIP-XAVANDERX OP_CHECKAWESOMESIG
...
The following applies to code changes to the Xavander Core project, and is not to be
confused with overall Xavander Network Protocol consensus changes.

Whether a pull request is merged into Xavander Core rests with the project merge
...
Patches that change Xavander consensus rules are considerably more involved than
...
Where a patch set proposes to change the Xavander consensus, it must have been
...
The project leader is the release manager for each Xavander Core release.
