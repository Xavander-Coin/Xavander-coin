...
public:
    ...
    void setZXavanderControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzXAVANDER_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzXAVANDER_clicked();
    void on_pushButtonZXavanderControl_clicked();
