                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Xavander Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xavander address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xavander: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXAVANDER"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Xavander Core"), this);
    aboutAction->setStatusTip(tr("Show information about Xavander Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Xavander"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xavander addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xavander addresses"));
    ...
    openAction->setStatusTip(tr("Open a Xavander: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Xavander Core help message to get a list with possible Xavander command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Xavander Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Xavander network", "", count));
}
...
{
    QString strTitle = tr("Xavander Core"); // default title
