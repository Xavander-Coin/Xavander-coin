...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Xavander Core"),
     ...
     * override -datadir in the xavander.conf file in the default data directory
     * (to be consistent with xavanderd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
