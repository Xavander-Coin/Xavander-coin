...
/** Utility functions used by the Xavander Qt UI.
 */
namespace GUIUtil
{
...
// Render Xavander addresses in monospace font
...
// Parse "xavander:" URI into recipient object, return true on successful parsing
