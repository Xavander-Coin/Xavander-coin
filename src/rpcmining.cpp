...
Value getmininginfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"difficulty\": smrtc.smrtcxx    (numeric) The current difficulty\n"
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "  \"previousblockhash\" : \"smrtcx\",    (string) The hash of current highest block\n"
            "  \"transactions\" : [                (array) contents of non-coinbase transactions that should be included in the next block\n"
            "      {\n"
            "         \"data\" : \"smrtcx\",          (string) transaction data encoded in hexadecimal (byte-for-byte)\n"
            "         \"hash\" : \"smrtcx\",          (string) hash/id encoded in little-endian hexadecimal\n"
            ...
            "  \"target\" : \"smrtcx\",               (string) The hash target\n"
            "  \"mintime\" : smrtc,                   (numeric) The minimum timestamp appropriate for next block time in seconds since epoch (Jan 1 1970 GMT)\n"
            ...
            "  \"bits\" : \"smrtc\",                 (string) compressed target of next block\n"
            "  \"height\" : n                      (numeric) The height of the next block\n"
            "  \"payee\" : \"smrtc\",                (string) required payee for the next block\n"
