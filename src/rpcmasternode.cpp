...
Value obfuscation(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() == 0)
        throw runtime_error(
            "obfuscation <smrtcaddress> <amount>\n"
            "smrtcaddress, reset, or auto (AutoDenominate)"
    ...
    if (params.size() != 2)
        throw runtime_error(
            "obfuscation <smrtcaddress> <amount>\n"
            "smrtcaddress, denominate, or auto (AutoDenominate)"
            "<amount> is a real and will be rounded to the next 0.1" +
            HelpRequiringPassphrase());
...
Value getpoolinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"state\": smrtcx,        (string) unknown\n"
            "  \"entries\": smrtcx,      (numeric) Number of entries\n"
            "  \"accepted\": smrtcx,     (numeric) Number of entries accepted\n"
            "}\n"
...
Value masternodecurrent (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"protocol\": smrtcx,        (numeric) Protocol version\n"
            "  \"txhash\": \"smrtcx\",      (string) Collateral transaction hash\n"
            "  \"pubkey\": \"smrtcx\",      (string) MN Public key\n"
...
Value startmasternode (const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3 ||
        ...
        throw runtime_error(
            ...
            "{\n"
            "  \"overall\": \"smrtcx\",     (string) Overall status message\n"
            "  \"detail\": [\n"
            "    {\n"
            "      \"node\": \"smrtcx\",    (string) Node name or alias\n"
            "      \"result\": \"smrtcx\",  (string) 'success' or 'failed'\n"
            "      \"error\": \"smrtcx\"    (string) Error message, if failed\n"
            "    }\n"
            "    ,...\n"
            "  ]\n"
            "}\n"
...
Value getmasternodeoutputs (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"txhash\": \"smrtcx\",    (string) output transaction hash\n"
...
Value listmasternodeconf (const Array& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 1))
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"alias\": \"smrtcx\",        (string) masternode alias\n"
            "    \"address\": \"smrtcx\",      (string) masternode IP address\n"
            "    \"privateKey\": \"smrtcx\",   (string) masternode private key\n"
            "    \"txHash\": \"smrtcx\",       (string) transaction hash\n"
            "    \"outputIndex\": n,       (numeric) transaction output index\n"
            "    \"status\": \"smrtcx\"        (string) masternode status\n"
            "  }\n"
            "  ,...\n"
            "]\n"
...
Value getmasternodestatus (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "  \"netaddr\": \"smrtcx\",     (string) Masternode network address\n"
            "  \"addr\": \"smrtcx\",        (string) Smrtc address for masternode payments\n"
            "  \"status\": \"smrtcx\",      (string) Masternode status\n"
            "  \"message\": \"smrtcx\"      (string) Masternode status message\n"
            "}\n"
...
Value getmasternodewinners (const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "    \"winner\": {\n"
            "      \"address\": \"smrtcx\",    (string) Smrtc MN Address\n"
...
Value getmasternodescores (const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  smrtcx: \"smrtcx\"   (numeric : string) Block height : Masternode hash\n"
            "  ,...\n"
            "}\n"
            "\nExamples:\n" +
