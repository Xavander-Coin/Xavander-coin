...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Xavander is not connected
    ...
    RPC_WALLET_PASSXAVANDERASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
