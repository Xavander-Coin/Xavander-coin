...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"version\": smrtcxx,           (numeric) the server version\n"
            "  \"protocolversion\": smrtcxx,   (numeric) the protocol version\n"
            "  \"walletversion\": smrtcxx,     (numeric) the wallet version\n"
            "  \"balance\": smrtcsmrtcx,         (numeric) the total smrtc balance of the wallet (excluding zerocoins)\n"
            "  \"zerocoinbalance\": smrtcsmrtcx, (numeric) the total zerocoin balance of the wallet\n"
            "  \"blocks\": smrtcsmrtc,           (numeric) the current number of blocks processed in the server\n"
            "  \"timeoffset\": smrtcxx,        (numeric) the time offset\n"
            "  \"connections\": smrtcxx,       (numeric) the number of connections\n"
            "  \"proxy\": \"host:port\",     (string, optional) the proxy used by the server\n"
            "  \"difficulty\": smrtcsmrtc,       (numeric) the current difficulty\n"
            ...
            "  \"paytxfee\": x.smrtcx,         (numeric) the transaction fee set in smrtc/kb\n"
            "  \"relayfee\": x.smrtcx,         (numeric) minimum relay fee for non-free transactions in smrtc/kb\n"
...
Value mnsync(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1 || (strMode != "status" && strMode != "reset")) {
        throw runtime_error(
            ...
            "  \"lastMasternodeList\": smrtcx,        (numeric) Timestamp of last MN list message\n"
            "  \"lastMasternodeWinner\": smrtcx,      (numeric) Timestamp of last MN winner message\n"
            "  \"lastBudgetItem\": smrtcx,            (numeric) Timestamp of last MN budget message\n"
            "  \"lastFailure\": smrtcx,           (numeric) Timestamp of last failed sync\n"
