...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x850de17f67155f42049dcc8f335144c6937617c68fc76046aca11e1be0285b49"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1534367188, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1534367188; // 07/25/2018 @ 5:45pm (UTC)
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1534367188;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 648116;
        ...
        assert(hashGenesisBlock == uint256("0x850de17f67155f42049dcc8f335144c6937617c68fc76046aca11e1be0285b49"));
        ...
        nStartMasternodePayments = 1534367188; // 
