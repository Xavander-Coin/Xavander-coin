...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Xavander Core xavander-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xavander-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xavander transaction") + "\n" +
                               "  xavander-tx [options] -create [commands]   " + _("Create hex-encoded xavander transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xavander transaction
