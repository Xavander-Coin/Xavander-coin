...
Value preparebudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"smrtcx\"       (string) proposal fee hash (if successful) or error message (if failed)\n"
            "\nExamples:\n" +
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"smrtcx\"       (string) proposal hash (if successful) or error message (if failed)\n"
            "\nExamples:\n" +
...
Value mnbudgetvote(const Array& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() == 3 && (strCommand != "local" && strCommand != "many")) || (params.size() == 4 && strCommand != "alias") ||
        ...
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"overall\": \"smrtcx\",      (string) The overall status message for the vote cast\n"
            "  \"detail\": [\n"
            "    {\n"
            "      \"node\": \"smrtcx\",      (string) 'local' or the MN alias\n"
            "      \"result\": \"smrtcx\",    (string) Either 'Success' or 'Failed'\n"
            "      \"error\": \"smrtcx\",     (string) Error message, if vote failed\n"
            "    }\n"
            "    ,...\n"
            "  ]\n"
            "}\n"
...
Value getbudgetvotes(const Array& params, bool fHelp)
{
    if (params.size() != 1)
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"mnId\": \"smrtcx\",        (string) Hash of the masternode's collateral transaction\n"
            "    \"nHash\": \"smrtcx\",       (string) Hash of the vote\n"
            "    \"Vote\": \"YES|NO\",      (string) Vote cast ('YES' or 'NO')\n"
            "    \"nTime\": smrtcx,         (numeric) Time in seconds since epoch the vote was cast\n"
...
Value getbudgetprojection(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"Name\": \"smrtcx\",               (string) Proposal Name\n"
            "    \"URL\": \"smrtcx\",                (string) Proposal URL\n"
            "    \"Hash\": \"smrtcx\",               (string) Proposal vote hash\n"
            "    \"FeeHash\": \"smrtcx\",            (string) Proposal fee hash\n"
            "    \"BlockStart\": n,              (numeric) Proposal starting block\n"
            "    \"BlockEnd\": n,                (numeric) Proposal ending block\n"
            "    \"TotalPaymentCount\": n,       (numeric) Number of payments\n"
            "    \"RemainingPaymentCount\": n,   (numeric) Number of remaining payments\n"
            "    \"PaymentAddress\": \"smrtcx\",     (string) Smrtc address of payment\n"
            "    \"Ratio\": x.smrtc,               (numeric) Ratio of yeas vs nays\n"
            "    \"Yeas\": n,                    (numeric) Number of yea votes\n"
            "    \"Nays\": n,                    (numeric) Number of nay votes\n"
            "    \"Abstains\": n,                (numeric) Number of abstains\n"
            "    \"TotalPayment\": smrtc.smrtc,      (numeric) Total payment amount\n"
            "    \"MonthlyPayment\": smrtc.smrtc,    (numeric) Monthly payment amount\n"
            "    \"IsEstablished\": true|false,  (boolean) Established (true) or (false)\n"
            "    \"IsValid\": true|false,        (boolean) Valid (true) or Invalid (false)\n"
            "    \"IsValidReason\": \"smrtcx\",      (string) Error message, if any\n"
            "    \"fValid\": true|false,         (boolean) Valid (true) or Invalid (false)\n"
            "    \"Alloted\": smrtc.smrtc,           (numeric) Amount alloted in current period\n"
            "    \"TotalBudgetAlloted\": smrtc.smrtc (numeric) Total alloted\n"
            "  }\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n" +
