...
RESOURCES += src/qt/xavander.qrc src/qt/xavander_locale.qrc

TRANSLATIONS += src/qt/locale/xavander_bg.ts \
                src/qt/locale/xavander_de.ts \
                src/qt/locale/xavander_en.ts \
                src/qt/locale/xavander_es.ts \
                src/qt/locale/xavander_fi.ts \
                src/qt/locale/xavander_fr.ts \
                src/qt/locale/xavander_it.ts \
                src/qt/locale/xavander_ja.ts \
                src/qt/locale/xavander_pl.ts \
                src/qt/locale/xavander_pt.ts \
                src/qt/locale/xavander_ru.ts \
                src/qt/locale/xavander_sk.ts \
                src/qt/locale/xavander_sv.ts \
                src/qt/locale/xavander_vi.ts \
                src/qt/locale/xavander_zh_CN.ts \
                src/qt/locale/xavander_zh_TW.ts
