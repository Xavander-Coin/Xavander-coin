...
In order to support loading of multiple wallets in xavander-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xavander.cpp.
...
Changes to xavander.cpp
----------------------
xavander.cpp is the entry point into xavander-qt, and as such, will require some minor modifications to provide hooks for
